...
/**
 * Trees without explicit links. Based on an assessment made by Stefan Kahrs,
 * implementation and weight balancing design made by Dylan Donovan
 * 
...
public class LinklessTree<T extends Comparable<? super T>> {
    ...
    private void moveDownRight(int i, int level) {
        ...
        // rightmost node being moved (the opposite for moveDownLeft). Then each
        // function call would break if its index
        // was null.
        boolean found = false;
     ...
     * 
     * @param i     index of the tree to be moved
     * @param level the level of {@code i} in the subtree being moved down.
     *              <b>Should be 0 for the first call</b>
     */
